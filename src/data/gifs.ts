...
export const gifs: GifEntry[] = [
  ...
  { url: "https://dzien.scooby.boo/test.gif", videoUrl: "https://dzien.scooby.boo/supersroda.mp4", gifFile: "test.gif", localFile: "test.gif" }, // Wednesday
  { url: "https://dzien.scooby.boo/test.gif", videoUrl: "https://dzien.scooby.boo/fajniedzialek.mp4", gifFile: "fajniedzialek.gif" }, // Thursday
